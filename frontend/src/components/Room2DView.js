...
const styles = {
    ...
    dimInput:        { width:60, padding:4, marginRight:8, fontSize:14,
    ...
    clearBtn:        { marginLeft:8, padding:'4px 8px', background:'#e74c3c',
        color:'#fff', border:'none', borderRadius:4, cursor:'pointer' },
    transformGrid:   { display:'grid', gridTemplateColumns:'repeat(2,1fr)', gap:10, marginTop:10 },
    actionBtn:       {
        padding:'8px 0', background:'linear-gradient(135deg,#7ed321,#6abf18)',
        color:'#fff', border:'none', borderRadius:6,
